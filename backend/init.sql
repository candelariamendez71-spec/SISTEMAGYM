...
INSERT OR IGNORE INTO gyms (id, nombre, logo, color, usuario, password) VALUES
  (1, 'Cyber Argento Gym', '/images/logo.png', '#00FFC6', 'cyber', '1234'),
  (2, 'Gimnasio Capital', '/images/logo.png', '#FF6B6B', 'capital', '5678'),
  (3, 'Gimnasio Norte', '/images/logo.png', '#4ECDC4', 'norte', 'abcd'),
  (4, 'Apolo Gym', '/images/logo.png', '#FFD700', 'apologymiseas', 'veronicaapolo873');
